    ...
    <div>
    {
      ...
      (<div className="flex gap-16 max-w-6xl p-6 mx-auto flex-wrap lg:flex-nowrap">
        ...
        <div className="md:w-[30%] w-full flex flex-col gap-8 justify-between">
            <div className="mt-20">
              <div className="text-xl text-[#166534] uppercase font-[600]"/> Your Cart
              <div className="text-5xl font-[600] text-[#15803d] uppercase mb-4"> Summary </div>
              <p className="font-[600] text-xl text-slate-700"><span>
      ...
      (<div className="w-screen h-[calc(100vh-80px)] flex flex-col gap-6 justify-center items-center">
        ...
        <Link to="/"> <button className="bg-[#16a34a] text-white text-md uppercase font-[600] py-3 px-10 rounded-md
        border-[#16a34a] border-2 hover:bg-white hover:text-[#16a34a] ease-in transition-all duration-300">Shop Now</button></Link>
      </div>)
    }
